...
#+begin_src bash
  python overcooked_isolated_example.py --use-cpu --num-envs 32
  MADRONA_MWGPU_KERNEL_CACHE=/tmp/overcache python overcooked_isolated_example.py --num-envs 32
#+end_src
...
|----------+----------+-------------+-------------|
|       32 | 2100     |      128000 |      212000 |
|      100 | 2000     |      242000 |      446000 |
|     1000 | -        |      183000 |     2300000 |
...
#+begin_src bash
  python overcooked_isolated_example.py --use-cpu --layout many_player_layout.layout --num-envs 1000 --num-players 2
  MADRONA_MWGPU_KERNEL_CACHE=/tmp/overcache python overcooked_isolated_example.py --layout many_player_layout.layout --num-envs 1000 --num-players 2
#+end_src
