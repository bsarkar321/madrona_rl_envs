    :
      ...
      getMemoryFdKHR( reinterpret_cast<PFN_vkGetMemoryFdKHR>(checkPtr(get_dev_addr(ctx, "vkGetMemoryFdKHR"), "vkGetMemoryFdKHR"))),
      getSemaphoreFdKHR( reinterpret_cast<PFN_vkGetSemaphoreFdKHR>(checkPtr(get_dev_addr(ctx, "vkGetSemaphoreFdKHR"), "vkGetSemaphoreFdKHR"))),
      ...
      createSwapchainKHR(!need_present ? nullptr : reinterpret_cast<PFN_vkCreateSwapchainKHR>(checkPtr(get_dev_addr(ctx, "vkCreateSwapchainKHR"), "vkCreateSwapchainKHR"))),
      destroySwapchainKHR(!need_present ? nullptr : reinterpret_cast<PFN_vkDestroySwapchainKHR>(checkPtr(get_dev_addr(ctx, "vkDestroySwapchainKHR"), "vkDestroySwapchainKHR"))),
      getSwapchainImagesKHR(!need_present ? nullptr : reinterpret_cast<PFN_vkGetSwapchainImagesKHR>(checkPtr(get_dev_addr(ctx, "vkGetSwapchainImagesKHR"), "vkGetSwapchainImagesKHR"))),
      acquireNextImageKHR(!need_present ? nullptr : reinterpret_cast<PFN_vkAcquireNextImageKHR>(checkPtr(get_dev_addr(ctx, "vkAcquireNextImageKHR"), "vkAcquireNextImageKHR"))),
      queuePresentKHR(!need_present ? nullptr : reinterpret_cast<PFN_vkQueuePresentKHR>(checkPtr(get_dev_addr(ctx, "vkQueuePresentKHR"), "vkQueuePresentKHR"))),
      createAccelerationStructureKHR(!need_rt ? nullptr : reinterpret_cast<PFN_vkCreateAccelerationStructureKHR>(checkPtr(get_dev_addr(ctx, "vkCreateAccelerationStructureKHR"), "vkCreateAccelerationStructureKHR"))),
      getAccelerationStructureBuildSizesKHR(!need_rt ? nullptr : reinterpret_cast<PFN_vkGetAccelerationStructureBuildSizesKHR>(checkPtr(get_dev_addr(ctx, "vkGetAccelerationStructureBuildSizesKHR"), "vkGetAccelerationStructureBuildSizesKHR"))),
      getAccelerationStructureDeviceAddressKHR(!need_rt ? nullptr : reinterpret_cast<PFN_vkGetAccelerationStructureDeviceAddressKHR>(checkPtr(get_dev_addr(ctx, "vkGetAccelerationStructureDeviceAddressKHR"), "vkGetAccelerationStructureDeviceAddressKHR"))),
      getBufferDeviceAddress(!need_rt ? nullptr : reinterpret_cast<PFN_vkGetBufferDeviceAddress>(checkPtr(get_dev_addr(ctx, "vkGetBufferDeviceAddress"), "vkGetBufferDeviceAddress"))),
      cmdBuildAccelerationStructuresKHR(!need_rt ? nullptr : reinterpret_cast<PFN_vkCmdBuildAccelerationStructuresKHR>(checkPtr(get_dev_addr(ctx, "vkCmdBuildAccelerationStructuresKHR"), "vkCmdBuildAccelerationStructuresKHR"))),
      cmdBuildAccelerationStructuresIndirectKHR(!need_rt ? nullptr : reinterpret_cast<PFN_vkCmdBuildAccelerationStructuresIndirectKHR>(checkPtr(get_dev_addr(ctx, "vkCmdBuildAccelerationStructuresIndirectKHR"), "vkCmdBuildAccelerationStructuresIndirectKHR"))),
      destroyAccelerationStructureKHR(!need_rt ? nullptr : reinterpret_cast<PFN_vkDestroyAccelerationStructureKHR>(checkPtr(get_dev_addr(ctx, "vkDestroyAccelerationStructureKHR"), "vkDestroyAccelerationStructureKHR"))),
      getDeviceAccelerationStructureCompatibilityKHR(!need_rt ? nullptr : reinterpret_cast<PFN_vkGetDeviceAccelerationStructureCompatibilityKHR>(checkPtr(get_dev_addr(ctx, "vkGetDeviceAccelerationStructureCompatibilityKHR"), "vkGetDeviceAccelerationStructureCompatibilityKHR"))),
      cmdCopyAccelerationStructureKHR(!need_rt ? nullptr : reinterpret_cast<PFN_vkCmdCopyAccelerationStructureKHR>(checkPtr(get_dev_addr(ctx, "vkCmdCopyAccelerationStructureKHR"), "vkCmdCopyAccelerationStructureKHR"))),
      cmdCopyMemoryToAccelerationStructureKHR(!need_rt ? nullptr : reinterpret_cast<PFN_vkCmdCopyMemoryToAccelerationStructureKHR>(checkPtr(get_dev_addr(ctx, "vkCmdCopyMemoryToAccelerationStructureKHR"), "vkCmdCopyMemoryToAccelerationStructureKHR"))),
      cmdCopyAccelerationStructureToMemoryKHR(!need_rt ? nullptr : reinterpret_cast<PFN_vkCmdCopyAccelerationStructureToMemoryKHR>(checkPtr(get_dev_addr(ctx, "vkCmdCopyAccelerationStructureToMemoryKHR"), "vkCmdCopyAccelerationStructureToMemoryKHR"))),
      cmdWriteAccelerationStructuresPropertiesKHR(!need_rt ? nullptr : reinterpret_cast<PFN_vkCmdWriteAccelerationStructuresPropertiesKHR>(checkPtr(get_dev_addr(ctx, "vkCmdWriteAccelerationStructuresPropertiesKHR"), "vkCmdWriteAccelerationStructuresPropertiesKHR")))
